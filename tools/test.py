...
def main():
    ...
    if rank == 0:
        if args.out:
            ...
            # Occupancy evaluation returns a metric dictionary rather than
            # the historical detection ``bbox_results`` list. Persist the
            # complete object so --out works for both result formats.
